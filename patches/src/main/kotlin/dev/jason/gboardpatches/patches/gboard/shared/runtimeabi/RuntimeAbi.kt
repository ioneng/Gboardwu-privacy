...
internal enum class RuntimeCallId(internal val encodedAbi: String) {
    ...
    TELEMETRY_RUNTIME_SHOULD_BLOCK_CLEARCUT("Ldev/jason/gboardpatches/extension/telemetry/GboardTelemetryRuntime;->shouldBlockClearcut()Z"),
    TELEMETRY_RUNTIME_SHOULD_BLOCK_GOOGLE_PLAY_SERVICES("Ldev/jason/gboardpatches/extension/telemetry/GboardTelemetryRuntime;->shouldBlockGooglePlayServices()Z"),
    TELEMETRY_RUNTIME_SHOULD_BLOCK_DAILY_PING("Ldev/jason/gboardpatches/extension/telemetry/GboardTelemetryRuntime;->shouldBlockDailyPing(Ljava/lang/Object;)Z"),
    TELEMETRY_RUNTIME_SHOULD_BLOCK_PRIMES("Ldev/jason/gboardpatches/extension/telemetry/GboardTelemetryRuntime;->shouldBlockPrimes(Ljava/lang/Object;)Z"),
    TELEMETRY_RUNTIME_SHOULD_BLOCK_TENOR("Ldev/jason/gboardpatches/extension/telemetry/GboardTelemetryRuntime;->shouldBlockTenor()Z"),
    TELEMETRY_RUNTIME_SHOULD_BLOCK_CRONET("Ldev/jason/gboardpatches/extension/telemetry/GboardTelemetryRuntime;->shouldBlockCronet(Landroid/content/Context;)Z"),
